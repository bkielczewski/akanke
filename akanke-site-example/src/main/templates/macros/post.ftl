...
<ul class="meta list-inline hidden-xs">
    ...
    <li><a href="${post.id}#comments"><i class="fa fa-comments-o"></i>${post.facebookStats.commentsboxCount}</a></li>
    <li><a href="${post.id}"><i class="fa fa-thumbs-o-up"></i>${post.facebookStats.likeCount}</a></li>
